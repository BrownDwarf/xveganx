...
\documentclass[revtex4]{emulateapj}% change onecolumn to iop for fancy, iop to onecolumn for manuscript
...
\shorttitle{V827 Tau starspots with K2 and IGRINS}
...
\begin{figure*}
\centering
  \includegraphics[width=0.5\textwidth]{figures/V827_Tau_Starfish_results.pdf}
...
{\it Facilities:} \facility{Smith (IGRINS)}, \facility{AAVSO}, \facility{CFHT (ESPaDOnS)}, \facility{INTEGRAL (OMC)}, \facility{ASAS}, \facility{CrAO:1.25m}, \facility{Gaia}
